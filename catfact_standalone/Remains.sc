Remains  {
	...
	*new {
	...
	init { arg server;
		...
		newsinewave.value(140, 0.4, 10.0);
		
		//output_amp_0_b = Bus.control(s, 1);
		//output_amp_1_b = Bus.control(s, 1);
		
		//output_amp_s = Synth.new(\inputamp, [\in, 0, \out, output_amp_0_b.index], og, \addToTail);
